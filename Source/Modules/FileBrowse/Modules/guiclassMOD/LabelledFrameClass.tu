...
class LabelledFrameClass
	...
	%Colin Creamer
	%More thurough text erasing to cover up Anti-aliusing edge artifacts

	%Top
	Font.Draw (text, x + labelX, y + labelY + 1, textFontID, backgroundColour)
	%bottom
	Font.Draw (text, x + labelX, y + labelY - 1, textFontID, backgroundColour)
	%Left
	Font.Draw (text, x + labelX - 1, y + labelY, textFontID, backgroundColour)
	%Right
	Font.Draw (text, x + labelX + 1, y + labelY, textFontID, backgroundColour)

	%Original Center cover
	Font.Draw (text, x + labelX, y + labelY, textFontID,
	    backgroundColour)
