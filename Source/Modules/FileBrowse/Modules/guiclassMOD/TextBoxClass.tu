...
class TextBoxClass
	...
	AddText, SetTopLine, SetSelectedLine, SetScrollOnAdd,
    % The package interface
	HScrollProc, VScrollProc
	
	%aditional RCC exports
	%selectLine
    ...
    deferred procedure SetSelectedLine (lineNumber : int)%Colin Creamer
    ...
    %deferred procedure selectLine (line : int) %(RCC) 
end TextBoxClass
